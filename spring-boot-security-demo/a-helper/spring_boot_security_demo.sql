...
VALUES (1, 0, 'system_setting', '系统配置', 1, NULL, 1, NULL, 1, 0);
INSERT INTO `authorize`
VALUES (2, 1, 'user', '用户管理', 2, NULL, 1, NULL, 2, 0);
INSERT INTO `authorize`
VALUES (3, 2, 'user:insert', '用户管理-新增', 3, NULL, 1, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (4, 2, 'user:select', '用户管理-查询', 3, NULL, 2, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (5, 2, 'user:update', '用户管理-编辑', 3, NULL, 3, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (6, 2, 'user:delete', '用户管理-删除', 3, NULL, 4, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (7, 1, 'role', '角色管理', 2, NULL, 1, NULL, 2, 0);
INSERT INTO `authorize`
VALUES (8, 7, 'role:insert', '角色管理-新增', 3, NULL, 1, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (9, 7, 'role:select', '角色管理-查询', 3, NULL, 2, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (10, 7, 'role:update', '角色管理-编辑', 3, NULL, 3, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (11, 7, 'role:delete', '角色管理-删除', 3, NULL, 4, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (12, 1, 'authorize', '权限管理', 2, NULL, 1, NULL, 2, 0);
INSERT INTO `authorize`
VALUES (13, 12, 'authorize:insert', '权限管理-新增', 3, NULL, 1, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (14, 12, 'authorize:select', '权限管理-查询', 3, NULL, 2, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (15, 12, 'authorize:update', '权限管理-编辑', 3, NULL, 3, NULL, 3, 0);
INSERT INTO `authorize`
VALUES (16, 12, 'authorize:delete', '权限管理-删除', 3, NULL, 4, NULL, 3, 0);
...
-- ----------------------------
INSERT INTO `role`
VALUES (1, 'admin', '超级管理员', '2023-03-11 13:58:25', '2023-03-11 13:58:27', 0);
...
-- ----------------------------
INSERT INTO `user`
VALUES (1, 'admin', '$2a$10$voVByDp713heOXHDigIUbu2mOIreU0nnwbKmokY5wYRvYRogaxGMG', '超级管理员', 0,
        '2023-03-10 15:42:10', '2023-03-10 15:42:13', '2023-03-10 15:42:20', 0, 0);
INSERT INTO `user`
VALUES (2, 'user', '$2a$10$voVByDp713heOXHDigIUbu2mOIreU0nnwbKmokY5wYRvYRogaxGMG', '普通用户', 0, '2023-03-10 18:19:51',
        '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, NULL);
INSERT INTO `user`
VALUES (3, 'user', '$2a$10$voVByDp713heOXHDigIUbu2mOIreU0nnwbKmokY5wYRvYRogaxGMG', '普通用户', 0, '2023-03-10 18:19:51',
        '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, 0);
INSERT INTO `user`
VALUES (5, 'user', '$2a$10$voVByDp713heOXHDigIUbu2mOIreU0nnwbKmokY5wYRvYRogaxGMG', '普通用户', 0, '2023-03-10 18:19:51',
        '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, NULL);
