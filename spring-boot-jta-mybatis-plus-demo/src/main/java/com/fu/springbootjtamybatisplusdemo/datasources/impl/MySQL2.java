package com.fu.springbootjtamybatisplusdemo.datasources.impl;

import com.baomidou.mybatisplus.extension.spring.MybatisSqlSessionFactoryBean;
import com.fu.springbootjtamybatisplusdemo.datasources.DataSourceConfiguration;
 ...
 */
@Configuration
@MapperScan(basePackages = DataSourceConfiguration.BASE_PACKAGES + DataSourceConfiguration.DOT + MySQL2.dataSourceName,
        sqlSessionFactoryRef = MySQL2.sqlSessionFactoryBeanName,
        sqlSessionTemplateRef = MySQL2.sqlSessionTemplateBeanName
)
public class MySQL2 implements DataSourceConfiguration {
    //需要看看上面basePackages、sqlSessionFactoryRef、sqlSessionTemplateRef是否当前类的变量名
    public static final String dataSourceName = "mysql2";
