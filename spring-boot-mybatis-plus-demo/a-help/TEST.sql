...
;
COMMENT
ON COLUMN "TEST"."ORACLEENTITY"."ID" IS '主键';
COMMENT
ON COLUMN "TEST"."ORACLEENTITY"."NAME" IS '姓名';

-- ----------------------------
-- Records of ORACLEENTITY
-- ----------------------------
INSERT INTO "TEST"."ORACLEENTITY"
VALUES ('1', 'Meta39');
...
-- ----------------------------
ALTER TABLE "TEST"."ORACLEENTITY"
    ADD CONSTRAINT "SYS_C0011104" PRIMARY KEY ("ID");

-- ----------------------------
-- Checks structure for table ORACLEENTITY
-- ----------------------------
ALTER TABLE "TEST"."ORACLEENTITY"
    ADD CONSTRAINT "SYS_C0011103" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Triggers structure for table ORACLEENTITY
-- ----------------------------
CREATE TRIGGER "TEST"."TRG_ORACLEENTITY"
    BEFORE INSERT
    ON "TEST"."ORACLEENTITY"
    REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW
BEGIN
select SEQ_ORACLEENTITY.nextval
into :NEW.ID
from dual;
END;
/
